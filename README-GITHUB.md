...
- **Issues**: [GitHub Issues](https://github.com/yourusername/tired-error-explainer/issues)
- **Discussions**: [GitHub Discussions](https://github.com/yourusername/tired-error-explainer/discussions)
- **Twitter**: [@yourusername](https://twitter.com/yourusername)

---

**Made with ❤️ for tired developers everywhere**
